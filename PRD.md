...
**受け入れ基準:**
- [x] test_csv_reader.pyに未カバーの分岐やエッジケースのテストを追加する
- [x] test_json_writer.pyに未カバーの分岐やエッジケースのテストを追加する
- [x] `uv run pytest tests/test_csv_reader.py tests/test_json_writer.py -v`が成功する
- [x] csv_reader.pyとjson_writer.pyのカバレッジを確認し、progress.txtに記録する
- [x] 型チェックが通過する
...
**受け入れ基準:**
- [x] test_genai_client.pyに未カバーの分岐やエッジケースのテストを追加する
- [x] test_metadata_service.pyに未カバーの分岐やエッジケースのテストを追加する
- [x] `uv run pytest tests/test_genai_client.py tests/test_metadata_service.py -v`が成功する
- [x] genai_client.pyとmetadata_service.pyのカバレッジを確認し、progress.txtに記録する
- [x] 型チェックが通過する
